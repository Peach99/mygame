...
function PopupLayer:addButton(tag)
	...
	if tag == Btn_OK_TAG then
    	...
    	self.btnOK:onButtonPressed(function(event)
    	    event.target:setScale(1.2)
    	end)
    	self.btnOK:onButtonRelease(function(event)
	...
	elseif tag == Btn_Cancel_TAG then
    	...
    	self.btnCancel:onButtonPressed(function(event)
    	    event.target:setScale(1.2)
    	end)
    	self.btnCancel:onButtonRelease(function(event)
    	    event.target:setScale(1.0)
    	end)
